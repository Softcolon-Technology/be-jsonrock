...
const modeSchema = Joi.string().valid('visualize', 'tree', 'formatter').required().messages({
...
const accessTypeSchema = Joi.string().valid('editor', 'viewer').default('viewer').messages({
